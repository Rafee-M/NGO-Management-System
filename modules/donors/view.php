...
// Only CEO can access
if (!checkPermission('CEO') || !checkPermission('Manager')) {
...
<head>
    ...
    <title>Donor Management - NGO Management</title>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    while ($row = $stmt->fetch()) {
                                        ...
                                        echo '<td>' . $row['city'] . '</td>';
                                        echo '<td>
                                            <a href="manage.php?id=' . $row['donor_id'] . '" class="btn btn-sm btn-warning">Edit</a>
                                            <!-- POST Delete Form -->
